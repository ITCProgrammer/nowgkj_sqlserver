...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-purple">
		  ...
		  <div class="card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Ganti Stiker</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
                  ...
                  <tr>
                    ...
                    <th colspan="2" style="text-align: center">Origin</th>
                    <th colspan="2" style="text-align: center">Destination</th>
                    <th rowspan="2" style="text-align: center">Code</th>
                    <th rowspan="2" style="text-align: center">Elements</th>
                    <th rowspan="2" style="text-align: center">Qty</th>
                    <th rowspan="2" style="text-align: center">KG</th>
                    <th rowspan="2" style="text-align: center">Userid</th>
                  </tr>
                  <tr>
...
WHERE s.ITEMTYPECODE='KFF' AND s.LOGICALWAREHOUSECODE ='M031' AND
s.TEMPLATECODE = '313' AND TIMESTAMP(TRIM(s.TRANSACTIONDATE),TRIM(s.TRANSACTIONTIME) ) BETWEEN '$Awal 23:00:00' AND '$Akhir 23:00:00' 
...
?>
      ...
      <td style="text-align: center"><?php echo $rowdb21['LOT_DESN']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['PRO_DESN']; ?></td>
