...
ON
	QCF.TRANSACTIONNUMBER = GKJ.TRANSACTIONNUMBER
		...
		AND (TRIM(b.WHSLOCATIONWAREHOUSEZONECODE) LIKE '%W1%' OR 
						TRIM(b.WHSLOCATIONWAREHOUSEZONECODE) LIKE '%W2%' OR
						...
						TRIM(b.WHSLOCATIONWAREHOUSEZONECODE) LIKE '%X6%' OR
						TRIM(b.WHSLOCATIONWAREHOUSEZONECODE) LIKE '%X7%')
...
if ($rowdb21['KET']!="" and $rowdb21['KET']!="100"){
	...
	$simpan=mysqli_query($con,"INSERT INTO `tbl_opname_detail` SET 
	itm	= '".$item."',
	...
	if($simpan){		
        echo "<meta http-equiv='refresh' content='0; url=PersediaanKainJadiFullDetailAuto.php?note=Berhasil'>";		
		}
