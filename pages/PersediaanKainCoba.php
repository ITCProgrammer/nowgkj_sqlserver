...
<!-- Main content -->
      <div class="container-fluid">
		<div class="alert alert-success alert-dismissible">
                  ...
                  Data Persediaan Kain hanya dari Zone W, X, Y, Z
                </div>  
   ...
   $c=0;
	...
	FROM 
		...
		LEFT OUTER JOIN ( SELECT USERGENERICGROUP.CODE,USERGENERICGROUP.LONGDESCRIPTION 
		FROM DB2ADMIN.USERGENERICGROUP USERGENERICGROUP ) u ON u.CODE = b.DECOSUBCODE05		
...
p.LONGDESCRIPTION,u.LONGDESCRIPTION) bl LEFT OUTER JOIN
	...
	if($rowdb21['LEGALNAME1']==""){$langganan="";}else{$langganan=$rowdb21['LEGALNAME1'];}
	if($rowdb21['ORDERPARTNERBRANDCODE']==""){$buyer="";}else{$buyer=$rowdb21['LONGDESCRIPTION'];}
...
$rowdb29 = db2_fetch_assoc($stmt9);	*/
	//svr10
	//$mysql1=mysqli_query($cond,"SELECT `nokk`,`grouping`,`hue` FROM `tbl_cocok_warna_dye` WHERE `nokk`='".$rowdb21['LOTCODE']."' ORDER BY id DESC limit 1");
