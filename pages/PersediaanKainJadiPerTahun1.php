 ...
 ";
   ...
   ?>
                  <tr>
                    ...
                    <td style="text-align: center"><a href="pages/cetak/PersediaanKainJadi2022Excel.php?thn=2022" target="_blank" class="btn btn-outline-info btn-xs"> <i class="fa fa-download"></i> Download</a>&nbsp;<a href="pages/cetak/PersediaanKainJadi2022DetailExcel.php?thn=2022" target="_blank" class="btn btn-outline-warning btn-xs"><i class="fa fa-download"></i> Detail</a></td>
                  </tr>
				 </tbody>
                <tfoot>						  
                  <tr>
...
GROUP BY b.PROJECTCODE) STK ";
	...
	?>
	  <tr>
	    <td style="text-align: center"><a href="pages/cetak/PersediaanKainJadiNoOrderExcel.php" target="_blank" class="btn btn-outline-info btn-xs"> <i class="fa fa-download"></i> Download</a>&nbsp;<a href="pages/cetak/PersediaanKainJadiNoOrderDetailExcel.php" target="_blank" class="btn btn-outline-warning btn-xs" title="Detail"> <i class="fa fa-download"></i> Detail</a></td>
	  <td style="text-align: center"><?php echo $rowdb21['ROLL'];?></td>
      <td style="text-align: right"><?php echo number_format(round($rowdb21['BERAT'],2),2);?></td>
      </tr>				  
<?php	$no++;
...
GROUP BY b.PROJECTCODE ) STK ";
	...
	?>
	  <tr>
	    <td style="text-align: center"><div class="btn-group"><a href="pages/cetak/PersediaanKainJadiFullExcel.php" target="_blank" class="btn btn-outline-info btn-xs"><i class="fa fa-download"></i> Download</a>&nbsp;<a href="pages/cetak/PersediaanKainJadiFullDetailExcel.php" target="_blank" class="btn btn-outline-warning btn-xs"><i class="fa fa-download"></i> Detail</a></div></td>
	  <td style="text-align: center"><?php echo $rowdb21['ROLL'];?></td>
      <td style="text-align: right"><?php echo number_format(round($rowdb21['BERAT'],2),2);?></td>
      </tr>				  
<?php	$no++;
