...
**** Data Persediaan Kain hanya dari Zone W, X Lokasi W1, W3, X1, X2, X6 (Balance di NOW)
		...
		<div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Detail Data Persediaan Kain Jadi Perhari</h3>				 
          </div>
              <!-- /.card-header -->
              <div class="card-body">
...
FROM tbl_opname_11 GROUP BY tgl_tutup ORDER BY tgl_tutup DESC LIMIT 60");		  
    while($r = mysqli_fetch_array($sql)){
		
?>
	  <tr>
	  <td style="text-align: center"><?php echo $no;?></td>
	  <td style="text-align: center"><div class="btn-group"><a href="DetailOpname11-<?php echo $r['tgl_tutup'];?>" class="btn btn-info btn-xs" target="_blank"> <i class="fa fa-link"></i> Lihat Data</a><a href="pages/cetak/DetailOpname11Excel.php?tgl=<?php echo $r['tgl_tutup'];?>" class="btn btn-success btn-xs" target="_blank"> <i class="fa fa-file"></i> Cetak Ke Excel</a></div></td>
