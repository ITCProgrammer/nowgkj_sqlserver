		...
		<div class="card card-gray">
          ...
          <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
                  ...
                  <tr>
					...
					<th style="text-align: center">Subcode1</th>
					<th style="text-align: center">Subcode2</th>
					<th style="text-align: center">Subcode3</th>
					<th style="text-align: center">Subcode4</th>
					<th style="text-align: center">Subcode5</th>
					<th style="text-align: center">Subcode6</th>
					<th style="text-align: center">Subcode7</th>
					<th style="text-align: center">Subcode8</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php
...
?>
      ...
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE01']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE02']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE03']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE04']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE05']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE06']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE07']; ?></td>
      <td style="text-align: center"><?php echo $rowdb21['DECOSUBCODE08']; ?></td>
      </tr>				  
<?php	$no++;
