...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-purple">
		  ...
		  <div class="card-footer">
			...
			<a href="pages/cetak/PersediaanKainExcel1.php?buyer=<?php echo $Buyer1; ?>&zone=<?php echo $Zone; ?>&project=<?php echo $Project; ?>&pono=<?php echo $POno; ?>&itemno=<?php echo $itemNo; ?>&warnano=<?php echo $NoWarna; ?>" class="btn btn-warning" target="_blank">Excel Stok GKJ</a>  
          ...
          <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
				  ...
				  <?php
	if($Project!=""){				  
	$WProject= " AND SALESORDER.CODE='$Project' " ;		
	}else{
	$WProject= " " ;	
	}
	
	if($Buyer1!=""){
	$WBuyer= " AND ITXVIEWAKJ.ORDERPARTNERBRANDCODE LIKE '%$Buyer1%' " ;	
	}else{
	$WBuyer= " ";	
	}
	...
	if($Zone!=""){
	$WZone= " AND b.WHSLOCATIONWAREHOUSEZONECODE='$Zone' " ;	
	}else{
	$WZone= " ";	
	}			  
					  
	if($Project=="" and $Buyer1=="" and $NoWarna=="" and $Item=="" and $Zone==""){
		$WKosong= " AND SALESORDER.CODE='' AND ITXVIEWAKJ.LONGDESCRIPTION='' AND bl.DECOSUBCODE05='' AND CONCAT(trim(bl.DECOSUBCODE02),CONCAT('',trim(bl.DECOSUBCODE03)))='' " ;
	}				  
   $no=1;   
   $c=0;
	$sqlDB21 = " SELECT bl.*,SALESORDER.CODE, SALESORDER.EXTERNALREFERENCE, SALESORDER.ORDPRNCUSTOMERSUPPLIERCODE,
		...
		FROM DB2ADMIN.SALESORDER SALESORDER LEFT OUTER JOIN DB2ADMIN.ITXVIEWAKJ 
       	...
       	(SELECT b.LOGICALWAREHOUSECODE,b.PROJECTCODE,b.LOTCODE,b.ITEMTYPECODE,b.DECOSUBCODE01,
b.DECOSUBCODE02,b.DECOSUBCODE03,b.DECOSUBCODE04,
b.DECOSUBCODE05,b.DECOSUBCODE06,b.DECOSUBCODE07,b.DECOSUBCODE08,  SUM(b.BASEPRIMARYQUANTITYUNIT) AS BASEPRIMARYQUANTITYUNIT,SUM(b.BASESECONDARYQUANTITYUNIT) AS BASESECONDARYQUANTITYUNIT FROM 
		BALANCE b WHERE (b.ITEMTYPECODE='FKF' OR b.ITEMTYPECODE='KFF') AND b.LOGICALWAREHOUSECODE='M031' $WZone
GROUP BY b.LOGICALWAREHOUSECODE,b.PROJECTCODE,b.LOTCODE,b.ITEMTYPECODE,b.DECOSUBCODE01,
b.DECOSUBCODE02,b.DECOSUBCODE03,b.DECOSUBCODE04,
b.DECOSUBCODE05,b.DECOSUBCODE06,b.DECOSUBCODE07,b.DECOSUBCODE08
) bl ON bl.PROJECTCODE=SALESORDER.CODE 
		WHERE (bl.ITEMTYPECODE='FKF' OR bl.ITEMTYPECODE='KFF') AND bl.LOGICALWAREHOUSECODE='M031' $WProject $WBuyer $WNoWarna $WNoItem $WKosong";
	...
	$sqlQC=mysqli_query($cond,"SELECT k.pelanggan,k.no_po,k.no_order  FROM db_qc.tmp_detail_kite tmp
		...
		$totmtr=$totmtr+$tmtr;
                ...
                <tfoot>
                  <tr>
                    ...
                    <td style="text-align: right">&nbsp;</td>
                    <td style="text-align: right"><strong>Roll</strong></td>
