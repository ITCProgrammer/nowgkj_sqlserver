...
<!-- Main content -->
	  ...
	  <div class="alert alert-success alert-dismissible">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Filter Data Per Item</h3>
		  ...
		  <div class="card-footer">
			...
			<a href="pages/cetak/PersediaanKainItemExcel.php?itemno=<?php echo $Item; ?>&warnano=<?php echo $NoWarna; ?>" class="btn btn-warning" target="_blank"><i class="far fa-file-excel"></i> Detail Stok</a>
			<a href="pages/cetak/PersediaanKainItemNewExcel.php?itemno=<?php echo $Item; ?>&warnano=<?php echo $NoWarna; ?>" class="btn btn-info" target="_blank"><i class="far fa-file-excel"></i> Detail Stok New</a>	
	...
	if($Warna!=""){
	$WWarna= " AND bl.DECOSUBCODE05='$Warna' " ;	
	}else{
	$WWarna= " ";	
	}				  
	if($Item!=""){
   ...
   $c=0;
	$sqlDB21 = " SELECT bl.*,SALESORDER.CODE, SALESORDER.EXTERNALREFERENCE, SALESORDER.ORDPRNCUSTOMERSUPPLIERCODE,
		ITXVIEWAKJ.LEGALNAME1, ITXVIEWAKJ.ORDERPARTNERBRANDCODE, ITXVIEWAKJ.LONGDESCRIPTION FROM 
		(SELECT SUM(b.BASEPRIMARYQUANTITYUNIT) AS BERAT,SUM(b.BASESECONDARYQUANTITYUNIT) AS YD,COUNT(b.BASESECONDARYQUANTITYUNIT) AS ROLL,b.LOTCODE,b.PROJECTCODE,
...
b.WHSLOCATIONWAREHOUSEZONECODE,b.WAREHOUSELOCATIONCODE) bl LEFT OUTER JOIN
