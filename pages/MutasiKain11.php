...
<div class="container-fluid">
  <form role="form" method="post" enctype="multipart/form-data" name="form1">
    <div class="card card-purple">
      <div class="card-header">
        <h3 class="card-title">Filter Data Mutasi Kain Jadi Dari Packing QC Jam 23:00</h3>
  ...
  ?>
    <div class="card card-pink">
      <div class="card-header">
        <h3 class="card-title">Data Laporan Harian Mutasi Kain Jadi Dari Packing QC <?php echo $tody . " s/d " . $tomrw; ?></h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
