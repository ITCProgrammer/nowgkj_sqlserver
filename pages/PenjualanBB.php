      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Filter Data Penjualan BB</h3>
		  ...
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Penjualan BB</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
LISTAGG(DISTINCT TRIM(WAREHOUSELOCATIONCODE),',') AS LK,QUALITYREASONCODE,CREATIONUSER FROM STOCKTRANSACTION 
WHERE TRANSACTIONDATE BETWEEN '$Awal' AND '$Awal' AND 
TEMPLATECODE ='304' AND 
(ITEMTYPECODE='FKF' OR ITEMTYPECODE='KFF') AND 
LOGICALWAREHOUSECODE ='M631' AND WHSLOCATIONWAREHOUSEZONECODE='KRM'
...
WHSLOCATIONWAREHOUSEZONECODE,WAREHOUSELOCATIONCODE,QUALITYREASONCODE,CREATIONUSER ";
...
?>
      ...
      <td style="text-align: left"><?php echo $rowdb21['ORDERCODE']; ?></td>
