<!-- Main content -->
      <div class="container-fluid">
		<div class="alert alert-success alert-dismissible">
                  ...
                  Upload Data Stock Kain Jadi BS
		</div>  
		<form role="form" method="post" enctype="multipart/form-data" name="form1" >  
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Upload Data Persediaan Kain BS</h3>
		  ...
		  <div class="card-footer">
           <a href="DataUploadBS" class="btn btn-info">Kembali</a>
          </div>
		  <!-- /.card-body -->
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['file']['name']) && in_array($_FILES['file']['type'], $fileMimes)) {
        ...
        while (($getData = fgetcsv($csvFile, 100000, ",")) !== FALSE) {
            ...
            mysqli_query($con, "INSERT INTO tbl_stokfull_bs 
                (tgl_buat, SN, KG, zone, lokasi, nowarna, warna, lot, id_upload) 
                VALUES (
                    '" . $tgl_buat . "', 
                    '" . $SN . "', 
                    '" . $KG . "', 
        ...
        // Update upload log
        $sqlupdateUP = mysqli_query($con, "UPDATE tbl_upload_bs SET 
            nama_file='$nameFile',
            tgl_upload=now()
            WHERE id='$idUp'");
