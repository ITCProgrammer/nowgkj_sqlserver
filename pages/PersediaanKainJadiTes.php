...
<!-- Main content -->
   ...
   $c=0;
	$sqlDB21 = "SELECT
                            ...
                            CASE 
                                WHEN trim(SALESORDER.ORDERPARTNERBRANDCODE) IS NULL THEN 'Periksa kembali kolom BRAND di SALESORDER'
                            ...
                            SUM(BALANCE.BASEPRIMARYQUANTITYUNIT) AS KG,
                            COUNT(BALANCE.BASEPRIMARYQUANTITYUNIT) AS ROLL,
							BALANCE.BASEPRIMARYUNITCODE AS SATUANKG,
                            SUM(BALANCE.BASESECONDARYQUANTITYUNIT) AS LENGTH,
