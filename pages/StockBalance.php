      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <select class="form-control select2bs4" style="width: 100%;" name="zone">
            ...
            <?php
              $qryZone = " SELECT * FROM $tblZone order by nama ASC";
              $sqlZ = sqlsrv_query($con, $qryZone, [], ["Scrollable" => SQLSRV_CURSOR_KEYSET]);
              logSqlError($sqlZ, 'list zone', __LINE__);
        ...
        <div class="form-group row">
          ...
          <select class="form-control select2bs4 " style="width: 100%;" name="lokasi" <?php if ($CKLokasi != "1") { ?> disabled <?php } ?>>
            <option value="">Pilih</option>
            <?php
            $qryLokasi = " SELECT * FROM $tblLokasi WHERE zone='$Zone' order by nama ASC";
            $sqlL = sqlsrv_query($con, $qryLokasi, [], ["Scrollable" => SQLSRV_CURSOR_KEYSET]);
            logSqlError($sqlL, 'list lokasi', __LINE__);
    ...
    <div class="card-body">
      <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
        ...
        <tbody>
          ...
          logSqlError($stmt1, 'DB2 stok balance', __LINE__);
          while ($stmt1 && ($rowdb21 = db2_fetch_assoc($stmt1))) {
            ...
            $rowdb23 = $stmt3 ? db2_fetch_assoc($stmt3) : [];
            ...
            $rowdb25 = $stmt5 ? db2_fetch_assoc($stmt5) : [];
            ...
            $rowdb26 = $stmt6 ? db2_fetch_assoc($stmt6) : [];
            if ($rowdb22['EXTERNALREFERENCE'] != "") {
              $PO = $rowdb22['EXTERNALREFERENCE'];
            } else {
              $PO = $rowdb26['EXTERNALREFERENCE'];
            ...
            $sqlDB27 = "SELECT
                          ADSTORAGE.NAMENAME,
                          ADSTORAGE.VALUEDECIMAL AS LEBAR1,
                          GSM.VALUEDECIMAL AS GSM1
                        FROM
                          DB2ADMIN.ADSTORAGE ADSTORAGE
                        RIGHT OUTER JOIN DB2ADMIN.PRODUCT PRODUCT
                        LEFT OUTER JOIN (
                            SELECT
                              PRODUCT.*,
                              ADSTORAGE.NAMENAME,
                            ...
                            WHERE
                              PRODUCT.ITEMTYPECODE = 'KFF'
                              AND ADSTORAGE.NAMENAME = 'GSM'
                          ) GSM ON PRODUCT.SUBCODE01 = GSM.SUBCODE01
                            AND PRODUCT.SUBCODE02 = GSM.SUBCODE02
                            AND PRODUCT.SUBCODE03 = GSM.SUBCODE03
                            AND PRODUCT.SUBCODE04 = GSM.SUBCODE04
                            AND PRODUCT.SUBCODE05 = GSM.SUBCODE05
                            AND PRODUCT.SUBCODE06 = GSM.SUBCODE06
                            AND PRODUCT.SUBCODE07 = GSM.SUBCODE07
                            AND PRODUCT.SUBCODE08 = GSM.SUBCODE08
                              ON ADSTORAGE.UNIQUEID = PRODUCT.ABSUNIQUEID
                        WHERE
                          PRODUCT.ITEMTYPECODE = '$rowdb21[ITEMTYPECODE]'
                          AND	PRODUCT.SUBCODE01 = '$rowdb21[DECOSUBCODE01]'
                          AND PRODUCT.SUBCODE02 = '$rowdb21[DECOSUBCODE02]'
                          AND PRODUCT.SUBCODE03 = '$rowdb21[DECOSUBCODE03]'
                          AND PRODUCT.SUBCODE04 = '$rowdb21[DECOSUBCODE04]'
                          AND PRODUCT.SUBCODE05 = '$rowdb21[DECOSUBCODE05]'
                          AND PRODUCT.SUBCODE06 = '$rowdb21[DECOSUBCODE06]'
                          AND PRODUCT.SUBCODE07 = '$rowdb21[DECOSUBCODE07]'
                          AND PRODUCT.SUBCODE08 = '$rowdb21[DECOSUBCODE08]'
                          AND ADSTORAGE.NAMENAME = 'Width'";
