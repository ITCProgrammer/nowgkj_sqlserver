      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Filter Data Masuk Kain Tahanan</h3>
		  ...
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Masuk Kain Tahanan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
LOGICALWAREHOUSECODE ='M039' AND WHSLOCATIONWAREHOUSEZONECODE ='GTH' 
