...
<div class="container-fluid">
  <form role="form" method="post" enctype="multipart/form-data" name="form1">
    <div class="card card-purple">
      <div class="card-header">
        <h3 class="card-title">Filter Data New</h3>
  ...
  <?php if ($Awal != "") {
    $tomrw = date('Y-m-d', strtotime($Awal . "+1 days")) . " 03:00:00";
    $tody = $Awal . " 03:00:00";
    ?>
...
WHERE
	   ...
	   DESIGNCOMPONENT.VARIANTCODE='$rowdb23[DECOSUBCODE08]' ";
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo substr($rowdb21['TGL'], 0, 10); ?>
                </td>
                ...
                <td style="text-align: left">
                  <?php echo $rowdb22['ITEMDESCRIPTION']; ?>
                </td>
                <td style="text-align: left">
          ...
          <tfoot>
            <tr>
              ...
              <td style="text-align: center">
                <strong>
                  <?= number_format(round($totalKG, 5), 5) ?>
                </strong>
              </td>
              <td style="text-align: center">&nbsp;</td>
              <td style="text-align: center">&nbsp;</td>
          ...
          <tbody>
            ...
            while ($rowdb21_bongkaran = db2_fetch_assoc($stmt1_bongkaran)) {
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo $rowdb21_bongkaran['ITEMELEMENTCODE']; ?>
                </td>
                <td style="text-align: center">
    ...
    <!-- Card Bongkaran Kain Returan -->

    <div class="card card-yellow">
      <div class="card-header">
        <h3 class="card-title">Data Laporan Harian Bongkaran Kain Returan</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example13" class="table table-sm table-bordered table-striped table-display" style="font-size:13px;">
          ...
          <tbody>
            ...
            while ($rowdb21_bongkaran_returan = db2_fetch_assoc($stmt1_bongkaran_returan)) {
              $kdbenang_bongkaran = trim($rowdb21_bongkaran_returan['DECOSUBCODE01']) . " " .
                trim($rowdb21_bongkaran_returan['DECOSUBCODE02']) . " " .
                trim($rowdb21_bongkaran_returan['DECOSUBCODE03']) . " " .
                trim($rowdb21_bongkaran_returan['DECOSUBCODE04']) . " " .
                trim($rowdb21_bongkaran_returan['DECOSUBCODE05']) . " " .
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo substr($rowdb21_bongkaran_returan['TRANSACTIONDATE'], 0, 10); ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_bongkaran_returan['ORDERCODE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_bongkaran_returan['LOTCODE']; ?>
                </td>
                <td style="text-align: left">
                  <?php echo $kdbenang_bongkaran; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_bongkaran_returan['ITEMELEMENTCODE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_bongkaran_returan['JML']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21_bongkaran_returan['KG']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_bongkaran_returan['PROJECTCODE']; ?>
                </td>
                <td style="text-align: center">
          ...
          <tfoot>
            <tr>
              ...
              <td style="text-align: right"><strong>Total</strong></td>
              <td style="text-align: center"><strong>
                  <?php echo $totJml_bongkaran_returan; ?>
                </strong></td>
              <td style="text-align: right"><strong>
                  <?php echo number_format(round($totKg_bongkaran_returan, 5), 5); ?>
                </strong></td>
              <td style="text-align: left">&nbsp;</td>
              <td style="text-align: center">&nbsp;</td>
            </tr>
        ...
        <table id="example14" class="table table-sm table-bordered table-striped table-display" style="font-size:13px;">
          ...
          <tbody>
            ...
            while ($rowdb21_pass_qty = db2_fetch_assoc($stmt1_pass_qty)) {
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo substr($rowdb21_pass_qty['TRANSACTIONDATE'], 0, 10); ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_pass_qty['LOTCODE']; ?>
                </td>
                <td style="text-align: left">
                  <?php echo $kdbenang_pass_qty; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_pass_qty['ITEMELEMENTCODE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_pass_qty['JML']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21_pass_qty['KG']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21_pass_qty['YARD']; ?>
                </td>
                <td style="text-align: left">
                  <?php echo $rowdb21_pass_qty['NOTE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_pass_qty['CREATIONUSER']; ?>
                </td>
              </tr>
          ...
          <tfoot>
            <tr>
              ...
              <td style="text-align: center"><strong>
                  <?php echo $totJml_pass_qty; ?>
                </strong></td>
              <td style="text-align: right"><strong>
                  <?php echo number_format(round($totKg_pass_qty, 5), 5); ?>
                </strong></td>
              <td style="text-align: left"><strong>
                  <?php echo number_format(round($totYard_pass_qty, 5), 5); ?>
                </strong></td>
              <td style="text-align: left">&nbsp;</td>
              <td style="text-align: center">&nbsp;</td>
            </tr>
    ...
    <div class="card card-success">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example15" class="table table-sm table-bordered table-striped table-display" style="font-size:13px;">
          <thead>
            <tr>
              <th style="text-align: center">No.</th>
              <th style="text-align: center">Tanggal</th>
          ...
          <tbody>
            ...
            while ($rowdb21_sample = db2_fetch_assoc($stmt1_sample)) {
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo substr($rowdb21_sample['TRANSACTIONDATE'], 0, 10); ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_sample['LOTCODE']; ?>
                </td>
                <td style="text-align: left">
                  <?php echo $kdbenang; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_sample['ITEMELEMENTCODE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_sample['JML']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21_sample['KG']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21_sample['YARD']; ?>
                </td>
                <td style="text-align: left">
                  <?php echo $rowdb21_sample['NOTE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_sample['CREATIONUSER']; ?>
                </td>
              </tr>
          ...
          <tfoot>
            <tr>
              ...
              <td style="text-align: center"><strong>Total</strong></td>
              <td style="text-align: center"><strong>
                  <?php echo $totJml_sample; ?>
                </strong></td>
              <td style="text-align: right"><strong>
                  <?php echo number_format(round($totKg_sample, 5), 5); ?>
                </strong></td>
              <td style="text-align: right"><strong>
                  <?php echo number_format(round($totYard_sample, 5), 5); ?>
                </strong></td>
              <td style="text-align: left">&nbsp;</td>
              <td style="text-align: center">&nbsp;</td>
            </tr>
	...
	<div class="card card-danger">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example16" class="table table-sm table-bordered table-striped table-display" style="font-size:13px;">
          <thead>
            <tr>
              <th style="text-align: center">No.</th>
              <th style="text-align: center">Tanggal</th>
          ...
          <tbody>
            ...
            while ($rowdb21_stocktake = db2_fetch_assoc($stmt1_stocktake)) {
              $kdbenang_stocktake = trim($rowdb21_stocktake['DECOSUBCODE01']) . " " .
                trim($rowdb21_stocktake['DECOSUBCODE02']) . " " .
                trim($rowdb21_stocktake['DECOSUBCODE03']) . " " .
                trim($rowdb21_stocktake['DECOSUBCODE04']) . " " .
                trim($rowdb21_stocktake['DECOSUBCODE05']) . " " .
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <?php echo substr($rowdb21_stocktake['TRANSACTIONDATE'], 0, 10); ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_stocktake['ORDERCODE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_stocktake['LOTCODE']; ?>
                </td>
                <td style="text-align: left">
                  <?php echo $kdbenang_stocktake; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_stocktake['ITEMELEMENTCODE']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_stocktake['JML']; ?>
                </td>
                <td style="text-align: right">
                  <?php echo $rowdb21_stocktake['KG']; ?>
                </td>
                <td style="text-align: center">
                  <?php echo $rowdb21_stocktake['PROJECTCODE']; ?>
                </td>
                <td style="text-align: center">
          ...
          <tfoot>
            <tr>
              ...
              <td style="text-align: right"><strong>Total</strong></td>
              <td style="text-align: center"><strong>
                  <?php echo $totJml_stocktake; ?>
                </strong></td>
              <td style="text-align: right"><strong>
                  <?php echo number_format(round($totKg_stocktake, 5), 5); ?>
                </strong></td>
              <td style="text-align: left">&nbsp;</td>
              <td style="text-align: center">&nbsp;</td>
            </tr>
...
<script>
  ...
  function cetak_cek(filename) {
    ...
    if (awal != "" && akhir != "") {
      let url = 'pages/cetak/keluar-kain-' + filename + '-excel.php?awal=' + awal + '&akhir=' + akhir + '';
