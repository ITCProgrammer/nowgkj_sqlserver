		...
		<div class="card card-purple">
          ...
          <div class="card-body">
            <div class="form-group row">
               <label for="tgl_awal" class="col-md-1">Tanggal Awal</label>
               <div class="col-md-2">  
			...
			<div class="form-group row">
               <label for="tgl_akhir" class="col-md-1">Tanggal Akhir</label>
               <div class="col-md-2">  
		  ...
		  <div class="card-footer">
			...
			<?php if($Awal!=""){   ?>
			<a href="pages/cetak/masukkainnew7bulanExcel.php?awal=<?php echo $Awal; ?>&akhir=<?php echo $Akhir; ?>" class="btn btn-danger float-right" target="_blank">Download</a> 
			<?php } ?>	
          </div>
		  <!-- /.card-body -->
	...
	<?php if($Awal!=""){ 
   	...
   	$tody 	= $Awal." 07:00:00";	  
		  ...
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Masuk Kain Jadi <?php echo $Awal." s/d ".$Akhir; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
ZN,
LK,
SUM(ROL_BALANCE) AS ROL_BALANCE,
SUM(KGS_BALANCE) AS KGS_BALANCE,
ZN_BALANCE,
LK_BALANCE
--*
FROM (SELECT TIMESTAMP(STK.TRANSACTIONDATE,STK.TRANSACTIONTIME) AS JAM ,* FROM (
SELECT
...
FROM
	STOCKTRANSACTION
	LEFT OUTER JOIN BALANCE ON BALANCE.ELEMENTSCODE = STOCKTRANSACTION.ITEMELEMENTCODE 
	LEFT OUTER JOIN QUALITYREASON ON STOCKTRANSACTION.QUALITYREASONCODE = QUALITYREASON.CODE
WHERE
STOCKTRANSACTION.TRANSACTIONDATE BETWEEN '$Awal' AND '$Akhir'
	AND 
STOCKTRANSACTION.TEMPLATECODE = '304'
	AND 
(STOCKTRANSACTION.ITEMTYPECODE = 'FKF'
		OR STOCKTRANSACTION.ITEMTYPECODE = 'KFF')
	AND 
STOCKTRANSACTION.LOGICALWAREHOUSECODE = 'M031'
	AND NOT STOCKTRANSACTION.WAREHOUSELOCATIONCODE = 'DOK'
	AND
NOT STOCKTRANSACTION.WAREHOUSELOCATIONCODE LIKE 'BBS%'
	AND 
NOT STOCKTRANSACTION.WAREHOUSELOCATIONCODE LIKE 'ZER%'
	AND STOCKTRANSACTION.LOTCODE LIKE '00%'
GROUP BY
	STOCKTRANSACTION.LOTCODE,
	STOCKTRANSACTION.TRANSACTIONDATE,
	STOCKTRANSACTION.TRANSACTIONTIME,
...
WHERE JAM BETWEEN '$Awal 07:00:00' AND '$Akhir 07:00:00'
GROUP BY 
LOTCODE,
TRANSACTIONDATE,
ITEMTYPECODE,
...
<?php	$no++;
	...
	<div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Retur Masuk Kain Jadi <?php echo $Awal." s/d ".$Akhir; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
WHERE
	...
	AND CONCAT(s.TRANSACTIONDATE, CONCAT(' ', s.TRANSACTIONTIME)) BETWEEN '$Awal 07:00:00' AND '$Akhir 07:00:00'
GROUP BY
	s.TRANSACTIONDATE,
	s.ORDERCODE,
	s.DECOSUBCODE02,
