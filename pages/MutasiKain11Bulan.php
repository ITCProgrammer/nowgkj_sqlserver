      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Filter Data Mutasi Kain Jadi Dari Packing QC Per Periode Jam 23:00</h3>
...
//   	$tody 	= $Awal." 07:00:00";
//	    $tomrw1 = date('Y-m-d', strtotime($Awal. "+1 days"));
//   	$tody1 	= $Awal;
		$tody	= $Awal." 23:00:00";
		$tomrw 	= $Akhir." 23:00:00";
		  ?>	  
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Mutasi Kain Jadi Dari Packing QC Per Periode <?php echo $tody." s/d ".$tomrw; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
