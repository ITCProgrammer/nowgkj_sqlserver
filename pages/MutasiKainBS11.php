...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Filter Data Mutasi Kain BS  Jam 23:00</h3>
	...
	$tomrw1 = $Awal;
   	$tody1 	= date('Y-m-d', strtotime($Awal. "-1 days"));
		  ?>	  
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Mutasi Kain BS <?php echo $tody." s/d ".$tomrw; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
LISTAGG(DISTINCT TRIM(WAREHOUSELOCATIONCODE),',') AS LK,QUALITYREASONCODE,QUALITYREASON.LONGDESCRIPTION FROM 
( 
SELECT
	GKJ.*
FROM
	...
	WHERE
		...
		AND ( LOGICALWAREHOUSECODE = 'M032' or LOGICALWAREHOUSECODE = 'M033' or LOGICALWAREHOUSECODE = 'M039')
		AND (ITEMTYPECODE='KFF' OR ITEMTYPECODE='FKF')
		AND TRIM(TRANSACTIONDATE) BETWEEN '$tody1' AND '$tomrw1' ) QCF
INNER JOIN  
(
	SELECT
		*, TIMESTAMP(TRANSACTIONDATE,TRANSACTIONTIME ) AS JAM
	...
	WHERE
		...
		AND LOGICALWAREHOUSECODE = 'M631'
		AND WHSLOCATIONWAREHOUSEZONECODE = '01'
		AND (ITEMTYPECODE='KFF' OR ITEMTYPECODE='FKF')
		AND TRIM(TRANSACTIONDATE) BETWEEN '$tody1' AND '$tomrw1' ) GKJ
ON
...
WHERE TIMESTAMP(TRIM(STOCKTRANSACTION.TRANSACTIONDATE),TRIM(STOCKTRANSACTION.TRANSACTIONTIME) ) BETWEEN '$tody' AND '$tomrw'  
GROUP BY LOTCODE,TRANSACTIONDATE,ITEMTYPECODE,DECOSUBCODE01,
DECOSUBCODE02,DECOSUBCODE03,DECOSUBCODE04,DECOSUBCODE05,
DECOSUBCODE06,DECOSUBCODE07,DECOSUBCODE08,PROJECTCODE,
WHSLOCATIONWAREHOUSEZONECODE,WAREHOUSELOCATIONCODE,QUALITYREASONCODE,QUALITYREASON.LONGDESCRIPTION ";
