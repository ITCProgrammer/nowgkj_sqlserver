 ...
 if($langganan!=""){
  ...
  if(trim($rowdb21['PROJECTCODE'])!=""){
   ...
   $pjng=number_format(round($rowdb21['BASESECONDARYQUANTITYUNIT'],2),2);
	...
	$simpan=mysqli_query($con,"INSERT INTO `tbl_opname_detail_bs_11` SET 
	itm	= '".$item."',
	...
	if($simpan){		
        echo "<meta http-equiv='refresh' content='30; url=PersediaanKainDetailBSZoneManual11.php?note=Berhasil'>";		
}
