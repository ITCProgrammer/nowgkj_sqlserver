      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
               ...
               <label for="zone" class="col-md-1">Zone</label>               
                 <select class="form-control select2bs4" style="width: 100%;" name="zone">
				   <option value="">Pilih</option>	 
					<?php $sqlZ=mysqli_query($con," SELECT * FROM tbl_zone_bs order by nama ASC"); 
				 ...
				 <div class="form-group row">
                    ...
                    <option value="">Pilih</option>	 
					<?php $sqlL=mysqli_query($con," SELECT * FROM tbl_lokasi_bs WHERE zone='$Zone' order by nama ASC"); 
		  ...
		  <div class="card-footer">
			...
			<a href="pages/cetak/PersediaanKainBSExcel.php?zone=<?php echo $Zone; ?>&lokasi=<?php echo $Lokasi; ?>" class="btn btn-warning" target="_blank">Excel Kain BS</a> 			
			</div> 
			<?php } ?>  
			<!--<div class="btn-group float-right">  
			<a href="pages/cetak/PersediaanKainBSZoneExcel1.php?zone=<?php echo $Zone; ?>&lokasi=<?php echo $Lokasi; ?>" class="btn btn-warning" target="_blank">Excel Kain BS</a> 			
			</div>  -->
          </div>
		  <!-- /.card-body -->
		  ...
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Stock Kain BS</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
