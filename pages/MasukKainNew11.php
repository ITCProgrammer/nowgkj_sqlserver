  ...
  <form role="form" method="post" enctype="multipart/form-data" name="form1">
    <div class="card card-purple">
      <div class="card-header">
        <h3 class="card-title">Filter Data Masuk Kain Jadi New Jam 23:00</h3>
        ...
        <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
          ...
          <tbody>
            ...
            $sqlDB21 = "SELECT
                        ...
                        SUM(BASEPRIMARYQUANTITY) AS KGS,
                        LOTCODE,
                        PROJECTCODE,
                      ...
                      FROM
                        STOCKTRANSACTION
                      WHERE
                        TIMESTAMP(TRIM(TRANSACTIONDATE), TRIM(TRANSACTIONTIME)) BETWEEN '$tody' AND '$tomrw'
                        AND TEMPLATECODE = '304'
                        AND (ITEMTYPECODE = 'FKF' OR ITEMTYPECODE = 'KFF')
                        AND LOGICALWAREHOUSECODE = 'M031'
                        AND NOT WAREHOUSELOCATIONCODE = 'DOK'
                        AND NOT WAREHOUSELOCATIONCODE LIKE 'BBS%'
                        AND NOT WAREHOUSELOCATIONCODE LIKE 'ZER%'
                        AND LOTCODE LIKE '00%'
                      GROUP BY
                        LOTCODE,
                        TRANSACTIONDATE,
            ...
            while ($rowdb21 = db2_fetch_assoc($stmt1)) {
              ...
              $sqlDB23 = "SELECT
                            s.EXTERNALREFERENCE AS PO_HEADER ,
                            s2.EXTERNALREFERENCE AS PO_LINE,
                            i.PROJECTCODE
                          FROM
                            ITXVIEWKK i
                          ...
                          WHERE
                            i.PRODUCTIONORDERCODE = '$rowdb21[LOTCODE]'";
              ...
              $sqlDB25 = "SELECT 
                          ...
                          FROM 
                            ITXVIEWRESEPCOLOR 
                          WHERE
                            ITXVIEWRESEPCOLOR.NO_WARNA='$rowdb21[DECOSUBCODE05]' 
                            AND ITXVIEWRESEPCOLOR.ARTIKEL='$rowdb21[DECOSUBCODE03]'";
              ...
              $sqlDB26 = "SELECT
                          ...
                          LEFT OUTER JOIN DB2ADMIN.DESIGNCOMPONENT DESIGNCOMPONENT ON DESIGN.NUMBERID = DESIGNCOMPONENT.DESIGNNUMBERID AND DESIGN.SUBCODE01 = DESIGNCOMPONENT.DESIGNSUBCODE01
                          WHERE
                            DESIGN.SUBCODE01 = '$rowdb21[DECOSUBCODE07]'
                            AND DESIGNCOMPONENT.VARIANTCODE = '$rowdb21[DECOSUBCODE08]'";
              ...
              $sqlDB27 = "SELECT 
                          ...
                          WHERE
                            ...
                            SUBCODE01='$rowdb21[DECOSUBCODE01]' 
                            AND SUBCODE02='$rowdb21[DECOSUBCODE02]' 
                            AND SUBCODE03='$rowdb21[DECOSUBCODE03]' 
                            AND SUBCODE04='$rowdb21[DECOSUBCODE04]' 
                            AND SUBCODE05='$rowdb21[DECOSUBCODE05]' 
