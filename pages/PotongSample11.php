...
(s.TEMPLATECODE = '098' OR s.TEMPLATECODE = '342') AND TIMESTAMP(TRIM(s.TRANSACTIONDATE),TRIM(s.TRANSACTIONTIME) ) BETWEEN '$Awal 23:00:00' AND '$Akhir 23:00:00' 
...
<?php	$no++;
	    ...
	    <td style="text-align: right"><strong><?php echo number_format(round($totYard,5),5); ?></strong></td>
