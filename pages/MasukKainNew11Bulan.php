...
<div class="container-fluid">
  ...
  <?php if ($Awal != "") {
    $tomrw   = date('Y-m-d', strtotime($Awal . "+1 days")) . " 23:00:00";
    $tody   = $Awal . " 23:00:00";
  ?>
          ...
          <tbody>
            ...
            $sqlDB21 = "SELECT
                      ...
                      FROM
                        STOCKTRANSACTION
                      WHERE
                        TIMESTAMP(TRIM(TRANSACTIONDATE), TRIM(TRANSACTIONTIME)) BETWEEN '$Awal 23:00:00' AND '$Akhir 23:00:00'
          ...
          <tbody>
            ...
            $sqlDB21_bongkaran = "SELECT
                                  ...
                                  WHERE
                                    ...
                                    AND TIMESTAMP(TRIM(s.TRANSACTIONDATE),TRIM(s.TRANSACTIONTIME) ) BETWEEN '$Awal 23:00:00' AND '$Akhir 23:00:00'
                                  GROUP BY
                                    s.TRANSACTIONDATE,
                                    s.ORDERCODE,
                                    s.DECOSUBCODE02,
