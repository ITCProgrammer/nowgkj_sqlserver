...
<div class="container-fluid">
  <div class="card card-pink">
    <div class="card-header">
      <h3 class="card-title">Stock Tanggal <?php echo htmlspecialchars($_GET['tgl'] ?? '', ENT_QUOTES); ?></h3>
    </div>
...
$tgl = $_GET['tgl'] ?? ''; // format: YYYY-MM-DD
...
$sql = " SELECT
    ...
    GROUP BY
        ...
        lot, satuan, satuan_len, zone, lokasi, lebar, gramasi, sts_kain
    ORDER BY
        MIN(id) ASC
";
