...
<!-- Main content -->
      <div class="container-fluid">
		...
		<div class="card card-purple">
          <div class="card-header">
            <h3 class="card-title">Filter Data Masuk Kain Jadi Per LotCode</h3>
		  ...
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Data Laporan Harian Masuk Kain Jadi Per LotCode</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
   ...
   $no=1;   
   $c=0;
	$sqlDB21 = " SELECT TRANSACTIONDATE,ITEMELEMENTCODE,ITEMTYPECODE,DECOSUBCODE01,
...
WHSLOCATIONWAREHOUSEZONECODE,WAREHOUSELOCATIONCODE,QUALITYREASONCODE,ITEMELEMENTCODE ";
...
?>
	  ...
	  <td style="text-align: left"><?php echo $rowdb21['ITEMELEMENTCODE']; ?></td>
