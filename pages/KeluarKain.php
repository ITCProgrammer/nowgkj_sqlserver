...
<div class="container-fluid">
  ...
  <div class="card card-pink">
    <div class="card-header">
      ...
      <a href="javascript:void(0)" class="btn btn-sm btn-info float-right"
        onclick="cetak_cek('data-laporan-harian-pengiriman')">Cetak Excel</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
WHERE
  ...
  <div class="card card-danger">
    <div class="card-header">
      ...
      <a href="javascript:void(0)" class="btn btn-sm btn-info float-right"
        onclick="cetak_cek('data-laporan-harian-bongkaran-kain')">Cetak Excel</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <tbody>
          ...
          $sqlDB21_bongkaran = "SELECT
                      ...
                      WHERE s.ITEMTYPECODE='KFF' AND s.LOGICALWAREHOUSECODE ='M031'
                        AND s.TEMPLATECODE = '120' AND s.TRANSACTIONDATE
  ...
  <div class="card card-primary">
    <div class="card-header">
      ...
      <a href="javascript:void(0)" class="btn btn-sm btn-info float-right"
        onclick="cetak_cek('data-laporan-harian-pass-qty')">Cetak Excel</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
  ...
  <div class="card card-success">
    <div class="card-header">
      ...
      <a href="javascript:void(0)" class="btn btn-sm btn-info float-right"
        onclick="cetak_cek('data-laporan-harian-potong-sample')">Cetak Excel</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <tbody>
          ...
          $sqlDB21_sample = " SELECT
                    ...
                    WHERE s.ITEMTYPECODE='KFF' AND s.LOGICALWAREHOUSECODE ='M031' AND a.VALUESTRING ='1'
                      AND (s.TEMPLATECODE = '098' OR s.TEMPLATECODE = '342') AND s.TRANSACTIONDATE
                      BETWEEN '$Awal' AND '$Akhir'
                    GROUP BY
                      s.TRANSACTIONDATE,
                      s.DECOSUBCODE02,
