<!-- Main content -->
      <div class="container-fluid">		
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Stock Tanggal <?php echo $_GET['tgl']; ?> Shift 3</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
   ...
   $no=1;   
   $c=0;
   $sql = mysqli_query($con," SELECT * FROM tbl_opname_shift WHERE tgl_tutup='$_GET[tgl]' and shift='3' ORDER BY id ASC");		  
