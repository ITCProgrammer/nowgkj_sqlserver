...
b.WHSLOCATIONWAREHOUSEZONECODE,b.WAREHOUSELOCATIONCODE,p.LONGDESCRIPTION,t.QUALITYREASONCODE,Q1.LONGDESCRIPTION) bl LEFT OUTER JOIN
	...
	if ($rowdb21['KET']!="" and $rowdb21['KET']!="100"){
		...
		$sts1="Tunggu Kirim"; } 	
	$simpan=mysqli_query($con,"INSERT INTO `tbl_opname_tes` SET 
	itm	= '".$item."',
	...
	if($simpan){		
        echo "<meta http-equiv='refresh' content='0; url=TutupHarianTesAuto.php?note=Berhasil'>";		
		}	
}
