      ...
      <div class="container-fluid">
		...
		<div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">Filter Tgl Tutup Persediaan Kain Jadi</h3>
...
*** Bisa tutup Mulai jam 21:00 Malam sampai jam 03:00 Pagi<br>
**** Data Persediaan Kain hanya dari Zone W, X Lokasi W1, W3, X1, X2, X6 (Balance di NOW)
		...
		<div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Detail Data Persediaan Kain Jadi Perhari (Tutup Auto Jam 03:00 Pagi)</h3>				 
          </div>
              <!-- /.card-header -->
              <div class="card-body">
...
FROM tbl_opname GROUP BY tgl_tutup ORDER BY tgl_tutup DESC LIMIT 60");		  
    while($r = mysqli_fetch_array($sql)){
		
?>
	  <tr>
	  <td style="text-align: center"><?php echo $no;?></td>
	  <td style="text-align: center"><div class="btn-group"><a href="DetailOpname-<?php echo $r['tgl_tutup'];?>" class="btn btn-info btn-xs" target="_blank"> <i class="fa fa-link"></i> Lihat Data</a><a href="pages/cetak/DetailOpnameExcel.php?tgl=<?php echo $r['tgl_tutup'];?>" class="btn btn-success btn-xs" target="_blank"> <i class="fa fa-file"></i> Cetak Ke Excel</a></div></td>
