...
<div class="container-fluid">
    ...
    <div class="card card-purple">
      ...
      <div class="card-body">
        ...
        <!--<div class="form-group row">
               ...
               <div class="col-md-2">  
                 <input name="pono" value="<?php //echo $POno;
        ...
        <div class="form-group row">
          <label for="warna" class="col-md-1">Warna</label>
          <div class="col-md-2">
            <input name="warna" value="<?php echo $Warna; ?>" type="text" class="form-control form-control-sm">
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-md-2">
            <select class="form-control select2bs4" name="zone">
              ...
              <option value="GTH" <?php if ($Zone == "GTH") {
                                    echo "SELECTED";
                                  } ?>>GTH</option>
            </select>
          </div>
      ...
      <div class="card-footer">
        ...
        <div class="btn-group float-right">
          <a href="pages/cetak/PersediaanKainTahananDetailExcel.php?buyer=<?php echo $Buyer1; ?>&zone=<?php echo $Zone; ?>&project=<?php echo $Project; ?>&pono=<?php echo $POno; ?>&itemno=<?php echo $Item; ?>&warnano=<?php echo $NoWarna; ?>" class="btn btn-warning" target="_blank">Excel Stok GKJ Tahanan</a>
          <!-- <a href="pages/cetak/PersediaanKainTahananALLExcel.php" class="btn btn-danger" target="_blank">Download Stok GKJ Tahanan</a>  -->
        </div>
      </div>
      <!-- /.card-body -->
  ...
  <div class="card card-pink">
    <div class="card-header">
      <h3 class="card-title">Stock Detail Data Kain Tahanan</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
        ...
        <tbody>
          ...
          if ($Warna != "") {
            $WWarna = " AND ITXVIEWCOLOR.WARNA='$Warna' ";
          } else {
            $WWarna = " ";
          }
          ...
          $sqlDB21 = "SELECT
                    ...
                    WHERE
                        ...
                        AND BALANCE.LOGICALWAREHOUSECODE = 'M039' 
          ...
          while ($rowdb21 = db2_fetch_assoc($stmt1)) {
            $sqlDB24 = " SELECT
                          CASE
                            ...
                            CASE
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'OPN' THEN 'Booking'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'STO' THEN 'Booking'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'RPE' THEN 'Sisa Ganti Kain'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'REP' THEN 'Sisa Ganti Kain'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'SAM' THEN 'Sisa MOQ'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'SME' THEN 'Sisa MOQ'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'RFD' THEN 'Sisa Ganti Kain'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) IS NULL
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'RFE' THEN 'Sisa Ganti Kain'
                              ---------------------------------------------------------------------------------------------------------------------
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) = '.'
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'OPN' THEN 'Booking'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) = '.'
                              AND SUBSTRING(STOCKTRANSACTION.PROJECTCODE, 0, 4) = 'STO' THEN 'Booking'
                              WHEN trim(QUALITYREASON.LONGDESCRIPTION) = '.'
            ...
            $sqlDB29 = "SELECT TRANSACTIONDATE FROM STOCKTRANSACTION 
                        ...
                        (TEMPLATECODE ='304' OR TEMPLATECODE ='342' OR TEMPLATECODE ='OPN') AND (ITEMTYPECODE='FKF' OR ITEMTYPECODE='KFF') AND LOGICALWAREHOUSECODE ='M039' ";
            ...
            $sqlDB30 = " SELECT
                        ...
                        WHERE
                          ...
                          QUALITYDOCLINE.QUALITYDOCPRODUCTIONORDERCODE='" . $rowdb21['LOT'] . "'
          ...
          ?>
            <tr>
              ...
              <td style="text-align: left"><?php echo $rowdb24['STATUS_KAIN']; ?></td>
          ...
          <?php $no++;
            ...
            if (trim($rowdb21['SATUAN']) == "yd") {
              $tyd = $rowdb21['LENGTH'];
            } else {
              $tyd = 0;
            }
            $totyd = $totyd + $tyd;
            if (trim($rowdb21['SATUAN']) == "m") {
              $tmtr = $rowdb21['LENGTH'];
            } else {
              $tmtr = 0;
            }
