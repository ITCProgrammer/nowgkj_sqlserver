...
FROM tbl_opname_bb_11 GROUP BY tgl_tutup ORDER BY tgl_tutup DESC LIMIT 60");		  
    while($r = mysqli_fetch_array($sql)){
		
?>
	  <tr>
	  <td style="text-align: center"><?php echo $no;?></td>
	  <td style="text-align: center"><div class="btn-group"><a href="DetailOpnameBB1-<?php echo $r['tgl_tutup'];?>" class="btn btn-danger btn-xs" target="_blank"> <i class="fa fa-link"></i> Lihat Data 1</a><a href="DetailOpnameBB-<?php echo $r['tgl_tutup'];?>" class="btn btn-info btn-xs" target="_blank"> <i class="fa fa-link"></i> Lihat Data</a><a href="pages/cetak/DetailOpnameBBExcel.php?tgl=<?php echo $r['tgl_tutup'];?>" class="btn btn-success btn-xs" target="_blank"> <i class="fa fa-file"></i> Cetak Ke Excel</a><a href="pages/cetak/DetailOpnameBB1Excel.php?tgl=<?php echo $r['tgl_tutup'];?>" class="btn btn-warning btn-xs" target="_blank"> <i class="fa fa-file"></i> Cetak Ke Excel 1</a></div></td>
      ...
      <td style="text-align: center"><a href="#" class="btn btn-xs btn-danger <?php if($r['tgl']==$r['tgl_tutup']){ }else{echo"disabled";} ?>" onclick="confirm_delete('DelOpnameBB-<?php echo $r['tgl_tutup']; ?>');" ><small class="fas fa-trash"> </small> Hapus</a></td>
      </tr>
