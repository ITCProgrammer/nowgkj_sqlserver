      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
		  ...
		  <div class="card-footer">
			...
			<div class="btn-group float-right btn-xs">  
			...
			<div class="btn-group">
                    ...
                    <button type="button" id="dropdownSubMenu1" class="btn btn-info dropdown-toggle dropdown-icon" data-toggle="dropdown">
                    ...
                    <div aria-labelledby="dropdownSubMenu1" class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="#">W3 Blok</a>	
					  ...
					  <a class="dropdown-item" href="pages/cetak/PersediaanKainALLZoneW3BBExcel.php">W3 Blok BB</a>
					  <a class="dropdown-item" href="pages/cetak/PersediaanKainALLZoneW3CCExcel.php">W3 Blok CC</a>
					  <a class="dropdown-item" href="pages/cetak/PersediaanKainALLZoneW3DDExcel.php">W3 Blok DD</a>
          ...
          <table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
                  ...
                  <tr>
                    ...
                    <th style="text-align: center">Tgl Kirim Terakhir</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php
...
LEFT OUTER JOIN 
	...
	STOCKTRANSACTION.ITEMELEMENTCODE = ELEMENTS.CODE
LEFT OUTER JOIN 
     	DB2ADMIN.QUALITYREASON QUALITYREASON ON
	STOCKTRANSACTION.QUALITYREASONCODE = QUALITYREASON.CODE
WHERE
...
LIMIT 1 ";		
	...
	$sqlDB30 = " SELECT
   QUALITYDOCLINE.VALUEQUANTITY AS GROUPING0, HUE.VALUEQUANTITY AS HUE0, 
   QUALITYDOCLINE.VALUEGROUPCODE  AS GROUPING1 ,HUE.VALUEGROUPCODE AS HUE1
FROM
    QUALITYDOCLINE 
LEFT OUTER JOIN 
(SELECT
  QUALITYDOCPRODUCTIONORDERCODE,VALUEGROUPCODE, VALUEQUANTITY
FROM
    QUALITYDOCLINE
WHERE
...
FROM
	...
	WHERE
		...
		AND LOTCODE = '".$rowdb21['LOTCODE']."'
	GROUP BY
		ORDERCODE ) A
LEFT OUTER JOIN SALESDOCUMENT B ON
	B.PROVISIONALCODE = A.ORDERCODE
ORDER BY
	B.CREATIONDATETIME DESC	 ";
...
?>
      ...
      <td style="text-align: center"><?php if($rowdb30['GROUPING1']!=""){echo $rowdb30['GROUPING1'];}else if($rowdb30['GROUPING0']=="1"){echo "A" ;}else if($rowdb30['GROUPING0']=="2"){echo "B" ;}else if($rowdb30['GROUPING0']=="3"){echo "C" ;}else if($rowdb30['GROUPING0']=="4"){echo "D" ;} ?></td>
      <td style="text-align: center"><?php if($rowdb30['HUE1']!=""){echo $rowdb30['HUE1'];}else if($rowdb30['HUE0']=="1"){ echo "RED";}else if($rowdb30['HUE0']=="2"){ echo "YELLOW";}else if($rowdb30['HUE0']=="3"){ echo "GREEN";}else if($rowdb30['HUE0']=="4"){ echo "BLUE";} ?></td>
      <td style="text-align: center"><?php if($rowdb31['GOODSISSUEDATE']<> ""){ echo date("d-m-Y", strtotime($rowdb31['GOODSISSUEDATE'])); } ?></td>
      </tr>				  
<?php	$no++;
