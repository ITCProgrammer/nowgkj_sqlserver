      ...
      <div class="container-fluid">
		...
		<div class="card card-purple">
		  ...
		  <div class="card-footer">
			...
			<a href="pages/cetak/PersediaanKainExcel1.php?buyer=<?php echo $Buyer1; ?>&zone=<?php echo $Zone; ?>&project=<?php echo $Project; ?>&pono=<?php echo $POno; ?>&itemno=<?php echo $Item; ?>&warnano=<?php echo $NoWarna; ?>" class="btn btn-warning" target="_blank">Excel Stok GKJ</a>  
   ...
   $c=0;
	$sqlDB21 = " SELECT bl.*,SALESORDER.CODE, SALESORDER.EXTERNALREFERENCE, SALESORDER.ORDPRNCUSTOMERSUPPLIERCODE,
		...
		FROM DB2ADMIN.SALESORDER SALESORDER LEFT OUTER JOIN DB2ADMIN.ITXVIEWAKJ 
       	...
       	(SELECT * FROM 
		BALANCE b WHERE (b.ITEMTYPECODE='FKF' OR b.ITEMTYPECODE='KFF') AND b.LOGICALWAREHOUSECODE='M031' $WZone) bl ON bl.PROJECTCODE=SALESORDER.CODE 
