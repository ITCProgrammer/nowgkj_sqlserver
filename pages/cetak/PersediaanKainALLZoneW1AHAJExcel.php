...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW1AH_AJ.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	(WAREHOUSELOCATIONCODE LIKE 'AH%' OR 
	WAREHOUSELOCATIONCODE LIKE 'AI%' OR
	WAREHOUSELOCATIONCODE LIKE 'AJ%') ";
