<?php
	...
	header("Content-Disposition: attachment; filename=persediaankainjadi202311".$_GET['tgl'].".xls"); //ganti nama sesuai keperluan
...
where tgl_tutup = ?
    ...
    logSqlError($stmt1, 'detail 2023', __LINE__);
