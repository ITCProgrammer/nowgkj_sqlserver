...
header("Content-Disposition: attachment; filename=detailOpnameSHift3_".$_GET['tgl']."_.xls");//ganti nama sesuai keperluan
...
<!-- Main content -->
      <div class="container-fluid">		
		  <div class="card card-pink">
              <div class="card-header">
                <h3 class="card-title">Stock Tanggal <?php echo $_GET['tgl']; ?> SHIFT 3 <?php echo $_GET['tipe']; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
   ...
   $no=1;   
   $c=0;
   $sql = mysqli_query($con," SELECT * FROM tbl_opname_shift WHERE tgl_tutup='$_GET[tgl]' AND tipe='$_GET[tipe]' AND shift='3' ORDER BY id ASC");		  
