...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW3EA_EJ.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	(WAREHOUSELOCATIONCODE LIKE 'EA%' OR 
	WAREHOUSELOCATIONCODE LIKE 'EB%' OR
	WAREHOUSELOCATIONCODE LIKE 'EC%' OR
	WAREHOUSELOCATIONCODE LIKE 'ED%' OR
	WAREHOUSELOCATIONCODE LIKE 'EE%' OR 
	WAREHOUSELOCATIONCODE LIKE 'EF%' OR
	WAREHOUSELOCATIONCODE LIKE 'EG%' OR
	WAREHOUSELOCATIONCODE LIKE 'EH%' OR
	WAREHOUSELOCATIONCODE LIKE 'EI%' OR
	WAREHOUSELOCATIONCODE LIKE 'EJ%'
	)";
