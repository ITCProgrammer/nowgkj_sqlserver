...
header("Content-Disposition: attachment; filename=MasukKainBulan.xls");//ganti nama sesuai keperluan
...
<table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
                  <thead>
                  <tr>
                    <th colspan="21" style="text-align: center">Data Laporan Harian Masuk Kain Jadi <?php echo $Awal." s/d ".$Akhir; ?></th>
                    </tr>
                  <tr>
                    ...
                    <th colspan="4" style="text-align: center">Balance Stok</th>
                    </tr>
                  <tr>
...
ON
	QCF.TRANSACTIONNUMBER = GKJ.TRANSACTIONNUMBER) STOCKTRANSACTION
LEFT OUTER JOIN BALANCE ON
	BALANCE.ELEMENTSCODE = STOCKTRANSACTION.ITEMELEMENTCODE
LEFT OUTER JOIN 

(SELECT ITEMELEMENTCODE,QUALITYREASONCODE FROM STOCKTRANSACTION	WHERE 
(ITEMTYPECODE = 'FKF'
		OR ITEMTYPECODE = 'KFF')
	AND 
LOGICALWAREHOUSECODE = 'M031'
ORDER BY CREATIONDATETIME DESC) STS
ON STS.ITEMELEMENTCODE=STOCKTRANSACTION.ITEMELEMENTCODE
LEFT OUTER JOIN QUALITYREASON ON
STOCKTRANSACTION.QUALITYREASONCODE = QUALITYREASON.CODE
LEFT OUTER JOIN QUALITYREASON Q1 ON
STS.QUALITYREASONCODE = Q1.CODE
WHERE
	 STOCKTRANSACTION.JAM BETWEEN '$Awal 07:00:00' AND '$Akhir 07:00:00'	
GROUP BY
	STOCKTRANSACTION.LOTCODE,
	STOCKTRANSACTION.TRANSACTIONDATE,
	STOCKTRANSACTION.ITEMTYPECODE,
