...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneX.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	//}else{
	$sqlDB21 = " SELECT * FROM 
	BALANCE b WHERE (b.ITEMTYPECODE='KFF' OR b.ITEMTYPECODE='FKF') AND b.LOGICALWAREHOUSECODE='M031' AND WHSLOCATIONWAREHOUSEZONECODE LIKE 'X%' ";
