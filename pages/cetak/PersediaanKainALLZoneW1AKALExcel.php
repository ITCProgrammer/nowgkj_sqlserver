...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW1AK_AL.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	(WAREHOUSELOCATIONCODE LIKE 'AK%' OR
	WAREHOUSELOCATIONCODE LIKE 'AL%') ";
