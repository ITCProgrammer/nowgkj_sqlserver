<?php
	...
	header("Content-Disposition: attachment; filename=persediaankainjadiFullDetailBB11.xls"); //ganti nama sesuai keperluan
...
<?php
    ...
    $schema = 'dbnow_gkj';
    $tblOpnameDetail = "[$schema].[tbl_opname_detail_bb_11]";
    $sqlErrors = [];
...
where tgl_tutup = ? ";
    ...
    logSqlError($stmt1, 'FullDetailBB tgl');
