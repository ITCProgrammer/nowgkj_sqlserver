...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW3FA_FD.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	(WAREHOUSELOCATIONCODE LIKE 'FA%' OR 
	WAREHOUSELOCATIONCODE LIKE 'FB%' OR
	WAREHOUSELOCATIONCODE LIKE 'FC%' OR
	WAREHOUSELOCATIONCODE LIKE 'FD%') ";
