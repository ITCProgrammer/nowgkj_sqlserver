...
header("Content-Disposition: attachment; filename=persediaanBalanceDetailNew_".$_GET['buyer']."_".$_GET['project']."_".$_GET['itemno']."_".$_GET['warnano']."_".$_GET['zone'].".xls");//ganti nama sesuai keperluan
...
<table id="example1" class="table table-sm table-bordered table-striped" style="font-size:13px;">
   ...
   if($Project!=""){				  
	...
	if($Project=="" and $Buyer1=="" and $NoWarna=="" and $Item=="" and $Zone==""){
		$WKosong= " AND Sbl.PROJECTCODE='' AND bl.DECOSUBCODE05='' AND CONCAT(trim(bl.DECOSUBCODE02),CONCAT('',trim(bl.DECOSUBCODE03)))='' " ;
	}				  
   $no=1;   
   $c=0;
	$sqlDB21 = " SELECT bl.*,SALESORDER.CODE, SALESORDER.EXTERNALREFERENCE, SALESORDER.ORDPRNCUSTOMERSUPPLIERCODE,
		...
		TRIM(b.WHSLOCATIONWAREHOUSEZONECODE)='X6')) bl LEFT OUTER JOIN
