<?php
	...
	header("Content-Disposition: attachment; filename=persediaankainjadiFullDetailBS11.xls"); //ganti nama sesuai keperluan
...
<?php
    ...
    $schema = 'dbnow_gkj';
    $tblOpnameDetail = "[$schema].[tbl_opname_detail_bs_11]";
    $sqlErrors = [];
...
where tgl_tutup = ? ";
    ...
    logSqlError($stmt1, 'FullDetailBS tgl');
