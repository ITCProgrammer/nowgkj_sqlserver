...
header("Content-Disposition: attachment; filename=persediaanBalanceALLZoneP32.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	AND NOT (b.PROJECTCODE IS NULL OR b.PROJECTCODE ='')
