...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	//}else{
	$sqlDB21 = " SELECT LOGICALWAREHOUSECODE, ITEMTYPECODE, 
DECOSUBCODE01, DECOSUBCODE02, DECOSUBCODE03, DECOSUBCODE04, 
DECOSUBCODE05, DECOSUBCODE06, DECOSUBCODE07, DECOSUBCODE08,
WHSLOCATIONWAREHOUSEZONECODE, WAREHOUSELOCATIONCODE, QUALITYLEVELCODE, LOTCODE,
PROJECTCODE, COUNT(ELEMENTSCODE) AS ROLL, SUM(BASEPRIMARYQUANTITYUNIT) AS KG, SUM(BASESECONDARYQUANTITYUNIT) AS YD
FROM 
	BALANCE b 
 
WHERE (b.ITEMTYPECODE='KFF' OR b.ITEMTYPECODE='FKF') AND 
b.LOGICALWAREHOUSECODE='M031' AND WHSLOCATIONWAREHOUSEZONECODE LIKE 'W%'
GROUP BY LOGICALWAREHOUSECODE, ITEMTYPECODE, 
DECOSUBCODE01, DECOSUBCODE02, DECOSUBCODE03, DECOSUBCODE04, DECOSUBCODE05, 
DECOSUBCODE06, DECOSUBCODE07, DECOSUBCODE08,
WHSLOCATIONWAREHOUSEZONECODE, WAREHOUSELOCATIONCODE, QUALITYLEVELCODE, 
LOTCODE, PROJECTCODE ";
