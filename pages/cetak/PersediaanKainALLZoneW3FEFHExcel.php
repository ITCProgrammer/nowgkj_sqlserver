...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW3FE_FH.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	(WAREHOUSELOCATIONCODE LIKE 'FE%' OR 
	WAREHOUSELOCATIONCODE LIKE 'FF%' OR
	WAREHOUSELOCATIONCODE LIKE 'FG%' OR
	WAREHOUSELOCATIONCODE LIKE 'FH%' ) ";
