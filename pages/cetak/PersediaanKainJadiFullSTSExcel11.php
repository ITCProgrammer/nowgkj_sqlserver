<?php
	...
	header("Content-Disposition: attachment; filename=persediaankainjadiFullSTS11_".$_GET['tgl']."_".$_GET['sts'].".xls"); //ganti nama sesuai keperluan
...
from
	$tblOpnameDetail tod
where tgl_tutup = ? and sts_kain = ? and SUBSTRING(orderno, 4, 2) > '22'
	    and LEN(LTRIM(RTRIM(orderno))) = 10 ";
	$stmt1   = sqlsrv_query($con,$sqlDB21, [$tgl, $sts], ["Scrollable" => SQLSRV_CURSOR_KEYSET]);
    logSqlError($stmt1, 'FullSTS tgl/sts');
