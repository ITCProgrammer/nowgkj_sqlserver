...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW3EK_ES.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	(WAREHOUSELOCATIONCODE LIKE 'EK%' OR 
	WAREHOUSELOCATIONCODE LIKE 'EL%' OR
	WAREHOUSELOCATIONCODE LIKE 'EM%' OR
	WAREHOUSELOCATIONCODE LIKE 'EN%' OR
	WAREHOUSELOCATIONCODE LIKE 'EO%' OR 
	WAREHOUSELOCATIONCODE LIKE 'EP%' OR
	WAREHOUSELOCATIONCODE LIKE 'EQ%' OR
	WAREHOUSELOCATIONCODE LIKE 'ER%' OR
	WAREHOUSELOCATIONCODE LIKE 'ES%'
	) ";
