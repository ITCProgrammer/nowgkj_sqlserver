<?php
	...
	header("Content-Disposition: attachment; filename=persediaankainjadiFullDetail11".$_GET['tgl'].".xls"); //ganti nama sesuai keperluan
...
where tgl_tutup = ? ";
    ...
    logSqlError($stmt1, 'FullDetailR11 tgl');
