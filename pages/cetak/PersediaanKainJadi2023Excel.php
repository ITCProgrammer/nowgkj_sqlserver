<?php
	...
	header("Content-Disposition: attachment; filename=persediaankainjadi".$_GET['thn'].".xls"); //ganti nama sesuai keperluan
...
if($Thn!=""){
	$Where = " AND SUBSTR(b.PROJECTCODE,4,2) = '$Thn' ";
}else{
	$Where = " AND SUBSTR(b.PROJECTCODE,4,2) IS NULL ";
}
?>
<table>
                  <tr>
...
if ($rowdb21['KET']!="" and $rowdb21['KET']!="100"){
	...
	?>
      ...
      <td><?php echo $jns; ?></td>
      <td><span><?php echo $row_deliverydate['DELIVERYDATE']; ?></span></td>
