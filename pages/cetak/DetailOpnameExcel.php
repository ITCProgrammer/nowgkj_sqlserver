...
header("Content-Disposition: attachment; filename=detailOpname_".$_GET['tgl']."_.xls");//ganti nama sesuai keperluan
...
<!-- Main content -->
   ...
   $no=1;   
   $c=0;
   $sql = mysqli_query($con," SELECT * FROM tbl_opname WHERE tgl_tutup='$_GET[tgl]' ORDER BY id ASC");		  
