...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW3BCD.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	AND (WAREHOUSELOCATIONCODE LIKE 'B%' OR WAREHOUSELOCATIONCODE LIKE 'C%' OR WAREHOUSELOCATIONCODE LIKE 'D%') ";
