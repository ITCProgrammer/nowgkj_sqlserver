<?php
$Awal	= isset($_GETT['awal']) ? $_GET['awal'] : '';
$Akhir	= isset($_GETT['akhir']) ? $_GET['akhir'] : '';
?>
...
WHERE CONCAT(TRIM(STOCKTRANSACTION.TRANSACTIONDATE),CONCAT(' ',TRIM(STOCKTRANSACTION.TRANSACTIONTIME))) BETWEEN '$tody' AND '$tomrw'  
