...
header("Content-Disposition: attachment; filename=persediaanBalanceZoneW3FA_FL.xls");//ganti nama sesuai keperluan
...
<table id="" class="">
   ...
   $c=0;
	...
	WAREHOUSELOCATIONCODE LIKE 'FD%' OR
	WAREHOUSELOCATIONCODE LIKE 'FE%' OR 
	WAREHOUSELOCATIONCODE LIKE 'FF%' OR
	WAREHOUSELOCATIONCODE LIKE 'FG%' OR
	WAREHOUSELOCATIONCODE LIKE 'FH%' OR
	WAREHOUSELOCATIONCODE LIKE 'FI%' OR
	WAREHOUSELOCATIONCODE LIKE 'FJ%' OR
	WAREHOUSELOCATIONCODE LIKE 'FK%' OR
